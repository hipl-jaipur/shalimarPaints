                          ...
                          Positioned(
                            ...
                            child: Column(
                              ...
                              children: [
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          GestureDetector(
                                            onTap: () {
                                              if(controller.sectionlist.isNotEmpty){
                                              controller
                                ...
                                Expanded(
                                  child: controller
                                          .filterActivityDataModel!.data!.isNotEmpty
                                      ? ListView.builder(
                                          itemCount: controller
                                              .filterActivityDataModel!
                                              .data!
                                          ...
                                          itemBuilder: (BuildContext context,
                                            ...
                                            var date = DateFormat('dd/mm/yyyy')
                                                .format(DateTime.parse(controller
                                                    ...
                                                    .createdOn
                                                    .toString()));
                                            return controller.filterActivityDataModel!.data![index]!
                                                .customername!
                                                .toLowerCase()
                                                                ...
                                                                style: TextStyle(
                                                                    ...
                                                                    fontWeight:
                                                                        FontWeight
                                                                            .bold)),
                                                            Text(
                                                                "(${controller.filterActivityDataModel!.data![index].customerCode.toString()}) ",
                                                                style: TextStyle(
                                                                    color:
                                                                        primaryColor,
                                                                    fontSize: 16,
