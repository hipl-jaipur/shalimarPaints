                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              ...
                                              Text(outStandingController.filteredDepotList![index].bucketTotal==null?"0":formatNumber(outStandingController.filteredDepotList![index].bucketTotal.truncate()),
                                              style: TextStyle(
                                                  color: blackTextColor,
                                                  fontSize: 16,
                                                  fontWeight: FontWeight.w500,
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Text(
                                            ...
                                            Text(outStandingController.filteredDepotList![index].age030==null?"0":formatNumber(outStandingController.filteredDepotList![index].age030.truncate()),
                                            style: TextStyle(
                                                color: blackTextColor,
                                                fontSize: 16,
                                                fontWeight:
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Text(
                                            ...
                                            Text(outStandingController.filteredDepotList![index].age3160==null?"0":formatNumber(outStandingController.filteredDepotList![index].age3160.truncate()),
                                            style: TextStyle(
                                                color: blackTextColor,
                                                fontSize: 16,
                                                fontWeight:
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Text(
                                            ...
                                            Text(outStandingController.filteredDepotList![index].age6190==null?"0":formatNumber(outStandingController.filteredDepotList![index].age6190.truncate()),
                                            style: TextStyle(
                                                color: blackTextColor,
                                                fontSize: 16,
                                                fontWeight:
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Text(
                                            ...
                                            Text(outStandingController.filteredDepotList![index].age91120==null?"0":formatNumber(outStandingController.filteredDepotList![index].age91120.truncate()),
                                            style: TextStyle(
                                                color: blackTextColor,
                                                fontSize: 16,
                                                fontWeight:
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Text(
                                            ...
                                            Text(outStandingController.filteredDepotList![index].age121150==null?"0":formatNumber(outStandingController.filteredDepotList![index].age121150.truncate()),
                                            style: TextStyle(
                                                color: blackTextColor,
                                                fontSize: 16,
                                                fontWeight:
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Text(
                                            ...
                                            Text(outStandingController.filteredDepotList![index].age151180==null?"0":formatNumber(outStandingController.filteredDepotList![index].age151180.truncate()),
                                            style: TextStyle(
                                                color: blackTextColor,
                                                fontSize: 16,
                                                fontWeight:
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Text(
                                            ...
                                            Text(outStandingController.filteredDepotList![index].age181Above==null?"0":formatNumber(outStandingController.filteredDepotList![index].age181Above.truncate()),
                                            style: TextStyle(
                                                color: blackTextColor,
                                                fontSize: 16,
                                                fontWeight:
