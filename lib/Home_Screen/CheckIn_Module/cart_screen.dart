                                  ...
                                  child: Form(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        TextFormField(
                                          controller: setOrderDataController
                                              .remarkController,
                                        ...
                                        Expanded(
                                          ...
                                          itemCount: setOrderDataController
                                                      .orderEditTag ==
                                                  "Edit"
                                              ? setOrderDataController.myCartEditList!.length
                                                                  ...
                                                                  setState(() {
                                                                    if (setOrderDataController
                                                                      ...
                                                                      if (setOrderDataController.myCartEditList[index]
                                                                              ...
                                                                              "Qty"] !=
                                                                          0) {
                                                                        setOrderDataController.myCartEditList[index]
                                                                            [
                                                                            "Qty"]--;
                                                                        ...
                                                                        setOrderDataController.myCartEditList[index]
                                                                            [
                                                                            "mrp"] = (setOrderDataController.myCartEditList[index]
                                                                                ['mrp'])! *
                                                                            setOrderDataController.myCartEditList[index]["Qty"];
                                                                        setOrderDataController.myCartEditList[index]
                                                                            [
                                                                        ...
                                                                        setOrderDataController
                                                                            .total = setOrderDataController
                                                                                .total -
                                                                            setOrderDataController.myCartEditList[index]["dpl"]!;

                                                                        stockController.totalAmount =
                                                                            setOrderDataController.total;
                                                                    ...
                                                                    /*  if (setOrderDataController.myCartEditList[index]
                                                                      ...
                                                                      if (stockController.myList[index]
                                                                        ...
                                                                        stockController
                                                                            .totalQty = stockController.totalQty
                                                                                .toInt() -
                                                                            1;
                                          ...
                                          children: [
                                            Expanded(
                                              child: GestureDetector(
                                                onTap: () {
                                                  if(setOrderDataController.orderEditTag == "Edit"){
                                                    setOrderDataController.myCartList.clear();
                                                ...
                                                onTap: () {
                                                  ...
                                                  if (_formKey.currentState!
                                                    ...
                                                    if (setOrderDataController
                                                            .orderEditTag ==
                                                        "Edit") {
                                                      print(setOrderDataController.myCartEditList.length);
