...
class _MyScedulePageState extends State<MyScedulePage> {
  ...
  GetScheduleDataController getScheduleDataController =
                                                                  ...
                                                                  children: [
                                                                    Row(
                                                                      ...
                                                                      children: [
                                                                        Flexible(
                                                                            child:
                                                                                Container(child: FittedBox(fit: BoxFit.fill, child: Text("Schedule For: ${controller.getScheduleDataModel!.data![index].schdulefor}(${controller.getScheduleDataModel!.data![index].customername})")))),
                                                                      ],
                                                                    ),
                                                                    SizedBox(
                                                                      height: 5,
