...
class _TargetVsActyalRegionState extends State<TargetVsActyalRegion> {
  ...
  void initState() {
    ...
    if (targetVsActualController.filteredRegionList.isEmpty &&
        targetVsActualController.filteredAllRegionList.isNotEmpty) {
      targetVsActualController.filteredRegionList
          .addAll(targetVsActualController.filteredAllRegionList);
    }
                                    ...
                                    suffixIcon: IconButton(
                                        onPressed: () {
                                          if (controller.isLoading.value ==
                                              false) {
                                            controller.getTargetVsActualData();
                                          } else {
                                            showSnackBar(
                                                "Loading",
                                                "please Wait...",
                                                            ...
                                                            child: Row(
                                                              ...
                                                              children: [
                                                                ...
                                                                Row(
                                                                  children: [
                                                                    Text(
                                                                      targetVsActualController.filteredRegionList![index].achivementPer ==
                                                                              null
                                                                          ? "0"
                                                                          : formatNumber(targetVsActualController
